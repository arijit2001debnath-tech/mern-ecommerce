            ...
            <div className="mr-[4rem] mt-[5rem] ">
                ...
                <form onSubmit={registerHandler} className="container w-[40rem]">
                    <div className="my-[2rem]">
                        ...
                        <input type="text" id="name" className="mt-1 p-2 border rounded w-full bg-gray-900 text-white"
                    ...
                    <div className="my-[2rem]">
                        ...
                        <input type="email" id="email" className="mt-1 p-2 border rounded w-full bg-gray-900 text-white"
                            placeholder="Enter email" value={email} onChange={(e) => setEmail(e.target.value)} />
                    </div>
                    <div className="my-[2rem]">
                        <label className="block text-sm font-medium text-white" htmlFor="password">Password</label>
                        <input type="password" id="password" className="mt-1 p-2 border rounded w-full bg-gray-900 text-white"
                            placeholder="Enter password" value={password} onChange={(e) => setPassword(e.target.value)} />
                    </div>
                    <div className="my-[2rem]">
                        <label className="block text-sm font-medium text-white" htmlFor="confirmpassword">Confirm password</label>
                        <input type="password" id="confirmpassword" className="mt-1 p-2 border rounded w-full bg-gray-900 text-white"
                ...
                <div className="my-[1rem] text-white">
                    <p>
