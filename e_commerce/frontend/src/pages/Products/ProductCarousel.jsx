...
const ProductCarousel = () => {
    ...
    return (
        <div className="mb-4 xl:block md:block text-white">
                        ...
                        products.map(({ image, _id, name, price, description, brand, createdAt, numReviews, rating, quantity,
                            ...
                            <div key={_id} className="mt-[2rem] ">
                                ...
                                <div className="flex justify-between w-[20rem] mt-[1rem]">
                                    <div className="one">
                                        <h2 >{name}</h2>
                                        <p className="mt-[2rem]">$ {price}</p> <br /> <br />
                                    ...
                                    <div className="flex justify-between w-[20rem]">
                                        <div className="one">
                                            ...
                                            <h1 className="flex items-center mb-6 w-[10rem]">
                                                <FaClock className="mr-2 text-white" /> Added : {moment(createdAt)
                                                    .fromNow()}
                                            </h1>
                                            <h1 className="flex items-center mb-6 w-[8rem]">
